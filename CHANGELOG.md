...
| Version | Notes |
| ------- | ----- |
| [**16.0.0** (unreleased)](https://github.com/rtfeldman/elm-css/tree/15.0.0) | Remove `asPairs`, `Css.Namespace`, and arithmetic operators. Don't report warnings, just emit CSS. Make `Property` opaque and more efficient. Fix `withMedia` nesting bug. (#352) Rename `Css.Foreign` to `Css.Global`. (#360) Remove `Css.Colors`. (#358)
| [**15.0.0**](https://github.com/rtfeldman/elm-css/tree/14.0.0) | Remove experimental border properties. (#438)
