...
| Version | Notes |
| ------- | ----- |
| [**14.0.0**](https://github.com/rtfeldman/elm-css/tree/14.0.0) | Remove `asPairs` and `Css.Namespace`. Don't report warnings, just emit CSS. Make `Property` opaque and more efficient.
