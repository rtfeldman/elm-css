...
all =
    Test.concat
        ...
        , testProperty { function = "lineHeight", property = "line-height" }
            ...
            , ( lineHeight (calc (px 5) plus (calc (pct 5) plus (vh 3))), "calc(5px + calc(5% + 3vh))" )
            , ( lineHeight (calc (px 5) plus (calc (pct 5) minus (vh 3))), "calc(5px + calc(5% - 3vh))" )
            , ( lineHeight (calc (px 5) minus (calc (pct 5) plus (vh 3))), "calc(5px - calc(5% + 3vh))" )
            , ( lineHeight (calc (px 5) minus (calc (pct 5) minus (vh 3))), "calc(5px - calc(5% - 3vh))" )
            , ( lineHeight (calc (calc (pct 5) plus (vh 3)) plus (px 5)), "calc(calc(5% + 3vh) + 5px)" )
            , ( lineHeight (calc (calc (pct 5) minus (vh 3)) plus (px 5)), "calc(calc(5% - 3vh) + 5px)" )
            , ( lineHeight (calc (calc (pct 5) plus (vh 3)) minus (px 5)), "calc(calc(5% + 3vh) - 5px)" )
            , ( lineHeight (calc (calc (pct 5) minus (vh 3)) minus (px 5)), "calc(calc(5% - 3vh) - 5px)" )
