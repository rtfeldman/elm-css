...
your stylesheet.
    ...
    stylesheet { name = "homepage" }
        $ body
            ...
            ~ color (rgb 7 7 7)
-}
stylesheet : { a | name : String } -> List StyleBlock -> List Declaration
...
mixin : Mixin
mixin =
  Mixin (\_ declarations -> declarations)
