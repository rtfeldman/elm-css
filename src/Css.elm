...
mediaQuery queryString snippets =
    media [ mediaString queryString ] snippets
...
{-| -}
mediaString : String -> MediaQuery
mediaString queryString =
    Structure.MediaQuery queryString
